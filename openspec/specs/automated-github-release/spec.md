# automated-github-release Specification

## Purpose
Define validation and tag-based semantic release behavior for changes reaching `main`, including dependency auditing, serialized publication, GitHub authentication, and the absence of release commits or package publication.
